...
{
    public class DetectionViewModel : NotificationObject
    {

        private Detection  _model;
        ...
        ///构造函数
        /// </summary>
        public DetectionViewModel(object page)
        {
            ...
            this.DetailCommand = new DelegateCommand(new Action(this.Detail));//删除
            this.Page = (Page)page;
        }
