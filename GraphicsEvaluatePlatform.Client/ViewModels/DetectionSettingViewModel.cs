...
{
    public class DetectionSettingViewModel : NotificationObject
    {
        private DetectionSetting _model;

        public DetectionSetting Model
        {
            get { return _model; }
            set
            {
        ...
        private readonly IDetectionSettingService DetectionSettingService;
        ...
        ///构造函数
        /// </summary>
        public DetectionSettingViewModel(object page)
        {
            DetectionSettingService = new DetectionSettingService();
            this.SearchCommand = new DelegateCommand(new Action(this.List));//查询
            this.DetailCommand = new DelegateCommand(new Action(this.Detail));//明细
