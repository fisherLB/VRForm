...
namespace GraphicsEvaluatePlatform.Repository
{
    public class OracleDBHelper
    {
        ...
        public static string OracleConnection = ConfigurationManager.AppSettings["ORACLECONSTR"];
        ...
        /// <returns></returns>
        public static Dictionary<string, OracleParameter[]> GetInsertOracleParameter(Dictionary<string, object> paramList, string tableName)
        {
            Dictionary<string, OracleParameter[]> dic = new Dictionary<string, OracleParameter[]>();
            OracleParameter[] sbSqlPaRe = new OracleParameter[0];
            if (paramList != null)
                sbSqlPaRe = new OracleParameter[paramList.Count];
            List<OracleParameter> ListSqlPa = new List<OracleParameter>();
            ...
            foreach (var item in paramList)
            {
                ...
                ListSqlPa.Add(new OracleParameter("@" + item.Key, item.Value.ToString()));
                // }
        ...
        public static Dictionary<string, OracleParameter[]> GetInsertOracleParameter(Dictionary<string, object> paramList, string tableName, string column_id)
        {
            Dictionary<string, OracleParameter[]> dic = new Dictionary<string, OracleParameter[]>();
            OracleParameter[] sbSqlPaRe = new OracleParameter[0];
            if (paramList != null)
        ...
        /// <returns></returns>
        public static Dictionary<string, OracleParameter[]> GetUpdateOracleParameter(Dictionary<string, object> paramList, string tableName, Dictionary<string, object> whereList, string id)
        {
            Dictionary<string, OracleParameter[]> dic = new Dictionary<string, OracleParameter[]>();
            OracleParameter[] sbSqlPaRe = new OracleParameter[0];
            if (paramList != null)
        ...
        /// <returns></returns>
        public static Dictionary<string, OracleParameter[]> GetDeleteOracleParameter(string tableName, Dictionary<string, object> whereList)
        {
            Dictionary<string, OracleParameter[]> dic = new Dictionary<string, OracleParameter[]>();
            OracleParameter[] sbSqlPaRe = new OracleParameter[0];
        ...
        /// <returns></returns>
        public static Dictionary<string, OracleParameter[]> GetSelectOracleParameter(string cols, string tableName, Dictionary<string, object> whereList)
        {
            Dictionary<string, OracleParameter[]> dic = new Dictionary<string, OracleParameter[]>();
            OracleParameter[] sbSqlPaRe = new OracleParameter[0];
        ...
        /// <returns></returns>
        public static Dictionary<string, OracleParameter[]> GetSelectOracleParameter(string cols, string tableName, Dictionary<string, object> whereList, string orderby)
        {
            Dictionary<string, OracleParameter[]> dic = new Dictionary<string, OracleParameter[]>();
            OracleParameter[] sbSqlPaRe = new OracleParameter[0];
        ...
        {
            using (OracleConnection connection = new OracleConnection(OracleConnection))
            {
        ...
        public static void PrepareCommand(OracleCommand cmd, OracleConnection conn, OracleTransaction trans, string cmdText, OracleParameter[] cmdParms)
        {
        ...
        {
            string connString = OracleConnection;
            using (OracleConnection conn = new OracleConnection(connString))
            {
                //using (OracleBulkCopy sqlbulkcopy = new OracleBulkCopy(OracleConnection, OracleBulkCopyOptions.UseInternalTransaction | OracleBulkCopyOptions.Default | OracleBulkCopyOptions.UseInternalTransaction))
                //{
        ...
        public static DataSet ExecuteSqlGetDataSet(CommandType cmdType, string cmdText, params OracleParameter[] cmdParms)
        {
            string connString = OracleConnection;
            using (OracleConnection conn = new OracleConnection(connString))
            {
