...
namespace GraphicsEvaluatePlatform.Infrastructure.Common.ImageHelper
{
    ...
    public class ImageHelper
    {
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        public static Bitmap Brightness_Pic(Bitmap a, int v)
        {
            try
            {
                int w = a.Width;
        ...
        //对比度调整
        public static Bitmap Contrast_Pic(Bitmap a, double v)
        {
        ...
        /// <returns></returns>
        public static Bitmap ContrastAndBrightnessr(Bitmap src)
        {
            int width = src.Width;
        ...
        private static void setRGB(Bitmap src, int v1, int v2, int width, int height, int[] outPixels)
        {
